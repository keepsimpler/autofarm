...
<!-- <div class="container-fluid px-0 pt-3 d-flex flex-column align-items-center"> -->
    ...
    <div class="row no-gutters mt-1 mb-3 header">
        ...
        <div class="col d-flex align-items-center">
            <div class="list-search">
                <input type="text" class="ml-3 border-0" placeholder="多伦多市，安大略省，加拿大">
    ...
    <div id="dtitle" class="row no-gutters mt-4 mb-1">
        <h4 class="m-0">
            M-Kite加拿大海外仓
        </h4>
        <div class="col d-flex justify-content-end align-items-end">CAD <span>120.00</span>/㎡·天
            <small>起</small>
        </div>
    </div>
    ...
    <div id="dcontact" class="row no-gutters">
        <div class="col">
    ...
    <div id="dintro" class="row no-gutters">
        <div class="col">
    ...
    <div id="dprice" class="row no-gutters">
        <div class="col">
            ...
            <div class="ctable">
                ...
                <div class="d-flex flex-column price pt-1">
                    ...
                    <div class="mt-3">CAD 500.00</div>
                </div>
                <div class="d-flex flex-column remark pt-1">
                    <div>20GP</div>
                    <div class="mt-3">40GP</div>
                    <div class="mt-3">40HQ</div>
                    <div class="mt-3">45HQ</div>
                </div>
            </div>
            <div class="ctable bg-white">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>整柜有超过15件单箱超过22.00公斤, 200加币封顶</div>
                </div>
            </div>
            <div class="ctable">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>20尺柜超过500件，40尺柜超过1000件，45尺超过1000件</div>
                </div>
            </div>
            <div class="ctable bg-white">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>平板形，长条形等不规则货物，按照常规打板规格很难打板的货物含拉伸膜及
            ...
            <div class="ctable">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>含拉伸膜及人工费，不满一托按一托算，高度要求请提前告知</div>
                </div>
            </div>
            <div class="ctable bg-white">
            ...
            <div class="ctable">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>按照FBA仓库代码分货，需提前提供分货文件及清</div>
                </div>
            </div>
            <div class="ctable bg-white">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>按照FBA号码分货，需提前提供分货文件及清单，或者货物单箱重量超过
                        22.00kg/箱
                    </div>
                </div>
            </div>
            ...
            <div class="ctable">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>贴箱内标签，按标签个数收费，最低5.00加币起收</div>
                </div>
            </div>
            <div class="ctable bg-white">
            ...
            <div class="ctable bg-white">
                ...
                <div class="d-flex flex-column remark pt-1">
                    <div>53'整柜价格350加币。1小时免费等候时间，之后65加币每小时。</div>
                </div>
            </div>
            <div class="ctable">
                ...
                <div class="d-flex flex-column pl-5">
                    <div class="d-flex flex-row">
                        <div class="d-flex flex-column price pt-1">
                            <div class="ml-adjust">CAD 340.00/托盘</div>
                        </div>
                        <div class="d-flex flex-column remark pt-1">
                            <div class="ml-adjust">YYZ1-9。1小时免费等候时间，之后65加币每小时，53'整柜价格4950加币。</div>
                        </div>
                    </div>
                    <div class="d-flex flex-row">
                        <div class="d-flex flex-column price pt-1">
                            <div class="mt-3 ml-adjust">CAD 330.00/托盘</div>
                        </div>
                        <div class="d-flex flex-column remark pt-1">
                            <div class="mt-3 ml-adjust">YOW1。1小时免费等候时间，之后65加币每小时。</div>
                        </div>
                    </div>
                    <div class="d-flex flex-row">
                        <div class="d-flex flex-column price pt-1">
                            <div class="mt-3 ml-adjust">CAD 220.00/托盘</div>
                        </div>
                        <div class="d-flex flex-column remark pt-1">
                            <div class="mt-3 ml-adjust">YYC1。1小时免费等候时间，之后65加币每小时</div>
                        </div>
                    </div>
                    <div class="d-flex flex-row">
                        <div class="d-flex flex-column price pt-1">
                            <div class="mt-3 ml-adjust">CAD 260.00/托盘</div>
                        </div>
                        <div class="d-flex flex-column remark pt-1">
                            <div class="mt-3 ml-adjust">YEG1。1小时免费等候时间，之后65加币每小时</div>
                        </div>
                    </div>
                </div>
            </div>
